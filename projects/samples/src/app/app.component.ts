...
const TREE_DATA: SampleNode[] = [
  ...
  //     {
  //       name: 'Adding New Items To Chart at Runtime',
  //       path: 'addingnewitemstochartatruntime',
  //     },
  //     {
  //       name: 'Page Size Organizational Chart',
  ...
  //     {
  //       name: 'Children & Assistants Levels',
  //       path: 'childrenandassistantsleveloffset',
  //     },
  //     {
  //       name: 'Adviser and Assistant item types',
  //       path: 'adviserandassistantitemtypes',
  //     },
  //     {
  //       name: 'Sub Advisers and Assistants',
  ...
  //     {
  //       name: 'Multiple root items in chart',
  //       path: 'multiplerootitemsinchart',
  //     },
  //     {
  //       name: 'Matrix layout of multiple root items',
  ...
  //     {
  //       name: 'Custom layout with invisible items',
  //       path: 'customlayoutwithinvisibleitems',
  //     },
  //     {
  //       name: 'Assistants Children Placement',
  //       path: 'placeassistantsabovechildren',
  //     },
  //     {
  //       name: 'Advisers Children Placement',
  ...
  //     {
  //       name: 'Labels cascades over connection lines',
  //       path: 'labelscascadesinfamilychart',
  //     },
  //     {
  //       name: 'Labels over matrix shaped nodes connection lines',
  ...
  //     {
  //       name: 'Zoom using CSS Scale Transform',
  //       path: 'zoomwithcssscaletransform',
  //     },
  //     { name: 'Labels & Item Template', path: 'itemtemplatelabel' },
  //     {
  //       name: 'Selection Checkbox Inside Item Template',
  ...
  //     {
  //       name: 'Level Annotation - Custom template',
  ...
  //     {
  //       name: 'Routing hidden grand parents connections',
  ...
  {
    name: 'Partecipogramma',
    children: [
      // { name: 'Esempio Grafo', path: 'examplegraph' },
      // { name: 'Esempio Albero', path: 'exampletree' },
      { name: 'Filtri', path: 'examplefilters' },
      { name: 'Società', path: 'exampleenel' },
    ],
  },
];
